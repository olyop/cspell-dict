...
export declare type CacheFormat = 'legacy' | 'universal';
 ...
 * A File System Path to a dictionary file.
 */
export declare type CustomDictionaryPath = FsPath;
 ...
 */
export declare type ReporterSettings = string | [string] | [string, Serializable];
/**
