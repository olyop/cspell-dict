export declare type ParserOptions = Record<string, unknown>;
export declare type ParserName = string;
 ...
 */
export declare type SourceMap = number[];
export declare type Range = readonly [start: number, end: number];
/**
 ...
 */
export declare type ScopeString = string;
export declare type Scope = ScopeChain | ScopeString;
