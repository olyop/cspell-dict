...
export declare type Groups = Record<string, string | undefined>;
...
export declare type AppliedScopes = Scope[];
 ...
 */
export declare type RangeRelativeToLine = [start: number, end: number, line: number];
/**
 * A Range where the start and end are relative to the beginning of the document.
 */
export declare type RangeAbsolute = [start: number, end: number];
export declare type Range = RangeAbsolute | RangeRelativeToLine;
