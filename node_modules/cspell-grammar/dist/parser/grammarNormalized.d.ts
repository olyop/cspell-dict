 ...
 * @pattern ^[-\w.]+$
 */
export declare type NScope = string;
/**
 * @pattern ^source\.[-\w.]+$
 */
export declare type NScopeSource = string;
export declare type NPattern = NPatternBeginEnd | NPatternInclude | NPatternMatch | NPatternName | NPatternPatterns | NPatternRepositoryReference;
 ...
 * @pattern ^([\w-]+|$self|$base)$
 */
export declare type NRepositoryReference = string;
/**
 * Reference to an external grammar.
 * @pattern ^source\..*$
 */
export declare type ExternalGrammarReference = string;
export declare type IncludeExternalRef = ExternalGrammarReference;
export declare type NRepository = Record<string, NPattern>;
export declare type NCaptures = Record<string | number, NScope>;
...
//# sourceMappingURL=grammarNormalized.d.ts.map